...
local OBJECTS = {
    ...
    ['Tictac Sahur'] = { emoji = '🕰️🕰️', important = true },
    ['Los Primos'] = { emoji = '🙆‍♂️🙆‍♂️', important = true },
    ...
    ['Guest 666'] = { emoji = '㊙️㊙️', important = true },
    ...
    ['Tung Tung Tung Sahur Returns'] = { emoji = '⚰️⚰️', important = true },
}
